...
<section class="invoice">
              ...
              <?php if(isset($_POST["inputResponsavel"]) && $_POST["inputResponsavel"] != "Não Informado"){?>
                <div class="row invoice-info">
                    <div class="col-sm-8 invoice-col">
              ...
              <?php }if(isset($_POST["inputParentesco"])){
              ...
              <?php  } if(isset($_POST["inputResponsavel"])){ 
                    if($_POST["inputResponsavel"] == "Não Informado" && calcularIdade($dataNascimento) <= "17"){ ?>
                    <p class="lead" style="color: red;">Aluno menor de idade Adicione um responsavel!</p>          
              <?php } }?>
