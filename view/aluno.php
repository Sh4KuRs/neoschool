...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php if(isset($_GET["editar"])) {
        require_once 'alunos/editarAluno.php';
    }
    if(isset($_GET["cadastrar"])){
        require_once 'alunos/adicionarAluno.php';
    }
    ?>
    <!-- Fim content -->
  </div>
...
$(document).ready(function() {
    $('#alunos').on('click', '.view_data', function(e) {
        e.preventDefault();
        var serializeDados = $('#alunos').serialize();
         
        $.ajax({
            url: '../model/modal-serialize.php',
            type: 'POST',
            data: serializeDados,
            success: function(data) {
...
var email = $("#inputUsuario"); 
        email.blur(function() { 
            $.ajax({ 
                url: '../controller/verificarUsuario.php', 
                type: 'POST', 
