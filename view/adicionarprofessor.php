...
<head>
  ...
  <title>Neo Escola | Professores</title>
       ...
       <div class="col-md-13">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h2 class="box-title">Adicionar Professor</h2>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="../controller/adicionarProfessor.php" method="post">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        ...
                        <input type="text" class="form-control" placeholder="Nome completo" name="inputNome">
                    </div>
                    <div class="col-xs-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control select2" name='inputTurma[]' multiple="multiple" data-placeholder="Selecione as turmas"
                              style="width: 100%;">
                            <?php 
              ...
              <div class="box-footer">
                  <button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> Adicionar Professor</button> <button type="button" class="btn btn-danger"><i class="fa  fa-trash" onclick="<?php header('Location:../view/adicionarprofessor.php'); ?>"></i> Cancelar</button>
              </div>
            </form>
        </div>
        <?php }else{
            require_once 'professor/editar.php';
        } ?> 
       <!-- Table Turmas -->
       </div>
        <div class="box">
              ...
              <table id="turmas" class="table table-bordered table-striped">
                ...
                <?php 
                   require_once '../class/control_professor.php';
                    ...
                    $listProf = $profConsulta->listarProfessores();
